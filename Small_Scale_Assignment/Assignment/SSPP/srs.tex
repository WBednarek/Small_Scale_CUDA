...
After all zeros reduction AS cage4.mtx will look as follows, zero left are only for graphical representation purposes, in the real CSR vector they don;t exist.
