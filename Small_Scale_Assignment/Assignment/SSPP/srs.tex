...
\begin{longtable}[h!]{ |s|p{2cm}|p{1.3cm}|p{1.3cm}|p{1.5cm}|p{2cm}|p{0.4cm}|  }
\hline
...
\chapter{Storing matrices in CSR and ELLPack formats}
...
\section{Creating CRS matrix approach}
